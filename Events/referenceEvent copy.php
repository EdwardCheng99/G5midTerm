...
<body>
    ...
    <div class="container">
        ...
        <div class="my-2 d-flex justify-content-between align-items-center">
            <div class="btn-group">
                <a href="?page=<?= $page ?>&amp;type=1" class="btn btn-info ">編號 <i class="fa-solid fa-arrow-down-short-wide"></i></a>
                <a href="?page=<?= $page ?>&amp;type=2" class="btn btn-info ">編號 <i class="fa-solid fa-arrow-down-wide-short"></i></a>
                <a href="?page=<?= $page ?>&amp;type=5" class="btn btn-info ">票價 <i class="fa-solid fa-arrow-down-short-wide"></i></a>
                <a href="?page=<?= $page ?>&amp;type=6" class="btn btn-info ">票價 <i class="fa-solid fa-arrow-down-wide-short"></i></a>
                <a href="?page=<?= $page ?>&amp;type=3" class="btn btn-info ">活動日 <i class="fa-solid fa-arrow-down-short-wide"></i></a>
                <a href="?page=<?= $page ?>&amp;type=4" class="btn btn-info ">活動日 <i class="fa-solid fa-arrow-down-wide-short"></i></a>
                <a href="?page=<?= $page ?>&amp;type=7" class="btn btn-info ">上架日 <i class="fa-solid fa-arrow-down-short-wide"></i></a>
                <a href="?page=<?= $page ?>&amp;type=8" class="btn btn-info ">上架日 <i class="fa-solid fa-arrow-down-wide-short"></i></a>
            </div>
